...
public class RobotContainer {
    ...
    private final JoystickButton stage3 = new JoystickButton(driver, 6);
    // private final JoystickButton middle2 = new JoystickButton(driver, 3);
    private final JoystickButton stage2 = new JoystickButton(driver, 2);
    ...
    // private final JoystickButton liftmoveup = new JoystickButton(driver, 1);
    // private final JoystickButton liftmovedown = new JoystickButton(driver, 4);
    private final JoystickButton stage1 = new JoystickButton(driver, 4);
    ...
    public RobotContainer() {
        ...
        //mlift.setDefaultCommand(new LiftTeleopCmd(mlift, 0.3));
    ...
    private void configureButtonBindings() {
        stage2.onTrue(new LiftCmd(mlift, 2.3).andThen(new Coral_shoot_cmd(intake_shooter, -0.2)).andThen(new LiftCmd(mlift, 0.15)));
        stage3.onTrue(new LiftCmd(mlift, 5.8).andThen(new Coral_shoot_cmd(intake_shooter, -0.2)).andThen(new LiftCmd(mlift, 0.15)));
        ...
        // liftmoveup.whileTrue(new LiftTeleopCmd(mlift, 0.1));
        // liftmoveup.whileFalse(new LiftTeleopCmd(mlift, 0));
        // liftmovedown.whileTrue(new LiftTeleopCmd(mlift, -0.1));
        // liftmoveup.whileFalse(new LiftTeleopCmd(mlift, 0));
        ...
        stage1.onTrue(new LiftCmd(mlift, 0).andThen(new Coral_shoot_cmd(intake_shooter, -0.1)).andThen(new LiftCmd(mlift, 0)));
